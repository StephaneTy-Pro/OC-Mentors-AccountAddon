...
const appmenu = {
	...
	fields:
	{
		...
		custom_css_data: {
			label: 'code css à injecter ?',
			title: 'saisir ici le code css à injecter directement dans la page web générée',
			labelPos: 'left',
			type: 'input',
			default: '',
		},
		...
		'use_student_cache':{
			section: ['Avancées', ''],
			label: 'Utiliser le cache étudiant',
			title : 'Lorsque l\' application recherche si un étudiant est présent on utilise un cache pour éviter de passer trop de temps dans les requêtes, désactiver le cache permettra de toujours faire une requete en base ',
			labelPos: 'left',
			type: 'checkbox',
			default: true,
		},
